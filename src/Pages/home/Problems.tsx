    ...
    <section className="bg-white py-20 px-6 md:px-20 ">
      ...
      <FadeIn>
        <div className="mx-auto text-center p-8 border-2 border-black w-full sm:w-fit mt-15 rounded-2xl shadow-sm bg-white/50 backdrop-blur-sm">
          ...
          <Link to="/book-a-demo"><button className="bg-brand-gold hover:bg-white text-white px-10 py-3 rounded-full hover:text-black font-semibold border-black border-2">
            Schedule A Demo
          </button>
          </Link>
        </div>
