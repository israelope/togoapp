  ...
  return (
    <section className="bg-brand-gold py-16 md:py-24 px-4 md:px-20 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          What We{" "}
          <span className="text-brand-dark underline decoration-brand-dark underline-offset-8">
            Do
          </span>
        </motion.h2>
        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:auto-rows-[220px]">
          ...
          >
            <h3 className="text-white text-3xl md:text-5xl font-bold italic mb-4">
              Need Something Bespoke?
            </h3>
            <p className="text-brand-gold text-lg md:text-xl max-w-lg mb-8">
              Get in touch with our friendly team to talk through your needs.
            </p>
            <Link to="/contact">
              <button className="bg-white text-brand-dark px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-brand-gold hover:text-white transition-all shadow-lg active:scale-95">
                Get In Touch
              </button>
            </Link>
          </motion.div>
