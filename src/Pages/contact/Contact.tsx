    ...
    <section className="min-h-screen bg-brand-gold pt-32 pb-20 px-6 md:px-20 flex items-center justify-center">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[2.5rem] overflow-hidden shadow-2xl">
        ...
        <div className="p-8 md:p-16">
          ...
          >
            <h2 className="text-brand-dark text-4xl md:text-5xl font-bold italic mb-2">
              Let's <span className="text-brand-gold">Connect.</span>
            </h2>
            <p className="text-gray-500 mb-10">
              Have a question or ready to scale? We're here to help.
            </p>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative group">
                  <input
                    ...
                    id="name"
                    required
                    className="w-full border-b-2 border-gray-200 py-3 focus:border-brand-gold outline-none transition-all peer bg-transparent text-black"
                    placeholder=" "
                  />
                  <label
                    htmlFor="name"
                    className="absolute left-0 top-3 text-gray-400 pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-brand-gold peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-xs"
                  >
                    Full Name
                  </label>
                </div>
              ...
              <div className="relative group">
                <select className="w-full border-b-2 border-gray-200 py-3 focus:border-brand-gold outline-none transition-all  bg-transparent text-black">
              ...
              <div className="relative group">
                <textarea
                  ...
                  rows={4}
                  required
                  className="w-full border-b-2 border-gray-200 py-3 focus:border-brand-gold outline-none transition-all peer bg-transparent resize-none text-black"
                  placeholder=" "
                />
                <label
                  htmlFor="message"
        ...
        <div className="relative bg-brand-dark p-8 md:p-16 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 space-y-12">
            <div>
              <h3 className="text-brand-gold text-sm font-black tracking-[0.3em] uppercase mb-6">
                Contact Information
              </h3>
              <div className="space-y-8">
                <div className="flex gap-6 group">
                  <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center group-hover:bg-brand-gold transition-colors">
                    <Phone
                      className="text-brand-gold group-hover:text-white"
                      size={20}
                    />
                  </div>
                  <div>
            ...
            <div className="pt-10 border-t border-white/10">
              <p className="text-gray-400 italic mb-4 font-light">
                "Our mission is to help your venue reach its full,
                commission-free potential."
              </p>
              <img
                src="/logo.png"
                alt="Togo Logo"
