...
import { Facebook, Linkedin, Mail, MapPin, Clock, Phone, ArrowRight } from 'lucide-react';
    ...
    <footer className="bg-brand-dark text-white pt-20 pb-10 px-6 md:px-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 border-b border-white/10 pb-12">
          <div>
            <h2 className="text-5xl md:text-7xl font-bold italic mb-4">Get in <span className="text-brand-gold">Touch</span></h2>
            <p className="text-gray-400 max-w-md">Stay updated with our ever-evolving booking ecosystem.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            <h4 className="text-brand-gold uppercase tracking-tighter font-bold">Newsletter</h4>
          ...
          {/* Col 2: Location */}
          <div className="space-y-6">
            <h4 className="text-brand-gold uppercase tracking-tighter font-bold">Location</h4>
            <div className="flex gap-3 text-gray-400">
              <MapPin size={20} className="shrink-0 text-white" />
              <p>Holmfield Mills, Holdsworth Road,<br/>Halifax, HX3 6SN</p>
            </div>
          </div>

          {/* Col 3: Hours */}
          <div className="space-y-6">
            <h4 className="text-brand-gold uppercase tracking-tighter font-bold">Opening Hours</h4>
            <div className="flex gap-3 text-gray-400">
          ...
          {/* Col 4: Contact */}
          <div className="space-y-6">
            <h4 className="text-brand-gold uppercase tracking-tighter font-bold">Quick Contact</h4>
            <div className="space-y-4 text-gray-400">
              <a href="tel:01133281109" className="flex gap-3 hover:text-white transition-colors">
                <Phone size={20} className="text-white" /> 0113 328 1109
              </a>
              <a href="#" className="flex gap-3 hover:text-white transition-colors">
                <Mail size={20} className="text-white" /> Enquiry Form
              </a>
              <div className="flex gap-4 pt-2">
                <a href="#" className="p-2 bg-white/5 rounded-full hover:bg-brand-gold transition-colors"><Facebook size={18} /></a>
                <a href="#" className="p-2 bg-white/5 rounded-full hover:bg-brand-gold transition-colors"><Linkedin size={18} /></a>
              </div>
            </div>
          </div>
