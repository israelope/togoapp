...
function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    ...
    >
          ...
          {activeMenu !== "main" && (
            ...
            >
              ...
              {activeMenu === "treatments" && (
                <>
                  <a href="/treatments/prosthetics" onClick={handleClose}>
                    Prosthetics
                  </a>
                  <a href="/treatments/orthotics" onClick={handleClose}>
                    Orthotics
                  </a>
                </>
              )}
      ...
      <div
        className={`p-6 pb-20 mt-auto transition-all duration-700 ${isOpen ? "opacity-100" : "opacity-0"}`}
      >
        <a
          href="/contact"
          onClick={handleClose}
          className="flex items-center justify-center w-full gap-2 px-6 py-4 border border-blue-600 text-[#2D2921] hover:bg-blue-600 hover:text-white transition-all"
        >
        ...
        <div className="container mx-auto flex items-center justify-between">
          <a href="/" className="flex-shrink-0">
            <img
              src={
                isScrolled
                  ? "/icons/proactive-logo.png"
                  : "/icons/proactive-logo-light.png"
              }
              alt="Logo"
          ...
          <nav
            className={`hidden lg:flex items-center gap-8 font-light ${isScrolled ? "text-[#2D2921]" : "text-white"}`}
          >
            <a href="/about" className="hover:text-[#A6885B] transition-colors">
              About
            </a>
            <div className="relative group py-4">
              ...
              <div className="absolute top-full left-0 w-48 bg-white shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all rounded-b-md overflow-hidden">
                <a
                  ...
                  className="block px-4 py-3 text-[#2D2921] hover:bg-gray-50"
                >
                  Prosthetics
                </a>
              </div>
            ...
            <a
              href="/stories"
              className="hover:text-[#A6885B] transition-colors"
            >
              Stories
            </a>
          </nav>
